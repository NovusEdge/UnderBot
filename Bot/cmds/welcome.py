...
async def welcome(member, botObj):
    ...
    time.sleep(1.5)
    await botObj.send_message(member, "Also, dont forget to share about yourself in `#introduce` yourself.")
...
async def welcome_command(ctx):
    ...
    time.sleep(1.5)
    await ctx.send("Also, dont forget to share about yourself in `#introduce` yourself. :smiley:")
